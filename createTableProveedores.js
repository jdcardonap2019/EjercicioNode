...
const { buildPathProveedores } = require('./buildPaths');
...
function create(){
    try {
        ...
        if (doesFileExist(buildPathProveedores)) {
            console.log('Deleting old build file');
            /* If the file exists delete the file from system */
            fs.unlinkSync(buildPathProveedores);
        }
        /* generate rows */
        ...
        fs.writeFileSync(buildPathProveedores, html);
